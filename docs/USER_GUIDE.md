# 📖 Velora CRM User Manual

Welcome to the **Velora CRM** User Guide. This document provides step-by-step instructions on how to use the dashboard features effectively.
