...
export const metadata = {
    title: "Privacy Policy | Velora CRM",
    description: "Privacy Policy and Data Handling for Velora CRM.",
};
                ...
                <div className="glass-panel p-8 md:p-12 rounded-3xl shadow-xl shadow-black/5 dark:shadow-black/20 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary hover:prose-a:text-primary/80 prose-p:leading-relaxed">
                        ...
                        <p className="lead text-lg text-muted-foreground mb-8">
                            At Velora CRM, we believe that your data is your property. This Privacy Policy details the strict boundaries regarding how information is handled when using our open-source, self-hosted WhatsApp Gateway.
                        </p>
                        ...
                        <p>
                            Because Velora CRM is designed to be <strong>self-hosted</strong>, all core data processing occurs exclusively on the hardware where you deploy the application.
                        </p>
                        <ul>
                            <li><strong>No Centralized Telemetry:</strong> The creators of Velora CRM do not receive telemetry, analytics, or usage reports about your WhatsApp interactions.</li>
                        ...
                        <ul>
                            ...
                            <li><strong>WhatsApp Sessions:</strong> Velora CRM acts as a bridge to WhatsApp Web. The session tokens (keys) necessary to maintain this connection are stored locally on your server.</li>
                        ...
                        <p>
                            While Velora CRM is built with modern security practices, the ultimate safety of your data depends on your hosting environment. We strongly recommend:
                        </p>
                        <ul>
                        ...
                        <p>
                            Velora CRM utilizes the <code>@whiskeysockets/baileys</code> library to communicate directly with WhatsApp's servers. By using this gateway, your server will establish a direct web-socket connection to WhatsApp. Please be aware that your use of WhatsApp is still subject to Meta's Privacy Policy.
                        </p>
